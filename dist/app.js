...
function initVue() {
  new Vue({
    ...
    data: {
      ...
      links: [{
        nome: "Home",
        drop: ["MaxCoach Education", "Course Portal", "Distant Learning", "Multimedia Pedagogy", "Modern Schooling", "Remote Training", "Health Coaching", "Gym Coaching", "Business"],
        drop2: ["Artist", "Kitchen Coach", "Motivation", "Dancing", "Guitar", "Yoga", "Photography", "Personal Finance"]
      }, {
        nome: "Pages",
    ...
    mounted: function mounted() {
      ...
      var x = setInterval(function () {
        ...
        var seconds = Math.floor(distance % (1000 * 60) / 1000); // aggiorna il valore del data
